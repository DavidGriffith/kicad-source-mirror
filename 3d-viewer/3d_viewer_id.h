...
enum id_3dview_frm
{
    ...
    ID_TOOL_SET_VISIBLE_ITEMS_RENDER,
    ID_TOOL_SET_VISIBLE_ITEMS_RENDER_REALISTIC,
    ID_TOOL_SET_VISIBLE_ITEMS_RENDER_BOARD_BODY,
    ID_TOOL_SET_VISIBLE_ITEMS_RENDER_FILLED_AREAS,

    ID_TOOL_SET_VISIBLE_ITEMS_3DMODELS,
    ID_TOOL_SET_VISIBLE_ITEMS_3DMODELS_TH,
    ID_TOOL_SET_VISIBLE_ITEMS_3DMODELS_SMD,
    ID_TOOL_SET_VISIBLE_ITEMS_3DMODELS_VIRTUAL,

    ID_TOOL_SET_VISIBLE_ITEMS_LAYERS,
    ID_TOOL_SET_VISIBLE_ITEMS_LAYERS_SILK,
    ID_TOOL_SET_VISIBLE_ITEMS_LAYERS_MASK,
    ID_TOOL_SET_VISIBLE_ITEMS_LAYERS_PASTE,
    ID_TOOL_SET_VISIBLE_ITEMS_LAYERS_ADHESIVE,

    ID_TOOL_SET_VISIBLE_ITEMS_USER,
    ID_TOOL_SET_VISIBLE_ITEMS_USER_COMMENTS,
    ID_TOOL_SET_VISIBLE_ITEMS_USER_ECO,
