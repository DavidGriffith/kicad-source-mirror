...
enum DISPLAY3D_FLG {
    ...
    FL_TOOL_SET_VISIBLE_ITEMS_RENDER_REALISTIC,
    FL_TOOL_SET_VISIBLE_ITEMS_RENDER_BOARD_BODY,
    FL_TOOL_SET_VISIBLE_ITEMS_RENDER_FILLED_AREAS,
    FL_TOOL_SET_VISIBLE_ITEMS_3DMODELS_TH,
    FL_TOOL_SET_VISIBLE_ITEMS_3DMODELS_SMD,
    FL_TOOL_SET_VISIBLE_ITEMS_3DMODELS_VIRTUAL,
    FL_TOOL_SET_VISIBLE_ITEMS_LAYERS_SILK,
    FL_TOOL_SET_VISIBLE_ITEMS_LAYERS_MASK,
    FL_TOOL_SET_VISIBLE_ITEMS_LAYERS_PASTE,
    FL_TOOL_SET_VISIBLE_ITEMS_LAYERS_ADHESIVE,
    FL_TOOL_SET_VISIBLE_ITEMS_USER_COMMENTS,
    FL_TOOL_SET_VISIBLE_ITEMS_USER_ECO,
